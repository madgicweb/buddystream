            ...
            if (get_site_option('tweetstream_user_settings_syncbp') == 0) {
                ...
                if ($user_metas) {
                 foreach ($user_metas as $user_meta) {
                    ...
                    if (false === $import  && get_user_meta($user_meta->user_id, 'tweetstream_synctoac', 1)) {
                        ...
                        if ($items && $items->error == '') {
                            ...
                            foreach ($items as $tweet) {
                                ...
                                if (!$activity_info ['activities'][0]->id && !$max && $goodFilterPass && !$badFilterPass && !$sourceFilterPass) {
