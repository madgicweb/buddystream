            ...
            if ($user_metas) {
                foreach ($user_metas as $user_meta) {
                    ...
                    if (!$limitReached && get_user_meta($user_meta->user_id, 'bs_youtube_username', 1)) {
                        ...
                        $importUrls = array('https://gdata.youtube.com/feeds/api/users/'.get_user_meta($user_meta->user_id, 'bs_youtube_username', 1) . '/favorites');
                                ...
                                foreach ($items as $item) {
                                    ...
                                    if (!$activity_info['activities'][0]->id && !$max) {
                                        ...
                                        $ts = strtotime($item->get_date());
                                         ...
                                         $return = buddystreamCreateActivity(array(
