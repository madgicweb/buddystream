          ...
          <table class="buddystream_table" cellspacing="0">
            ...
            <?php if(!get_site_option("buddystream_license_key")): ?>  
                 ...
                 <tr>
                    ...
                    <td><input type="text" name="cronurl" value="<?php echo "*/10 * * * * wget --spider http://".plugins_url() ."/import.php --connect-timeout=600 --read-timeout=600 --tries=1 --recursive --level=1 -nd --delete-after";?>" size="150" /></td>
                 </tr>
            <?php endif; ?>
