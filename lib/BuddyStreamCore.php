...
function BuddystreamShareButton() {  
     ...
     echo '<a href="' . get_site_url() . '/wp-content/plugins/buddystream/extentions/default/templates/ShareBox.php?content=' .  urlencode(strip_tags(bp_get_activity_content_body())) . '&link=' . urlencode(bp_get_activity_thread_permalink()) . ' " class="bs_lightbox button item-button">Sharebox!</a>';
}
