...
<link rel="stylesheet" href="<?php echo plugins_url();?>/buddystream/extensions/default/slickswitch.css" type="text/css" />
...
<?php echo BuddyStreamExtensions::tabLoader('flickr'); ?>
          ...
          <table class="buddystream_table" cellspacing="0">
            ...
            <tr class="header">
             ...
             <tr>
                ...
                <td><input class="switch icons" type="checkbox" name="buddystream_flickr_album" id="buddystream_flickr_album"/></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="buddystream_flickr_user_settings_maximport" value="<?php echo get_site_option('buddystream_flickr_user_settings_maximport'); ?>" size="5" /></td>
            </tr>
         </table>
