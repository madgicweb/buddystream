...
<div id="buddystream" class="container">
    <div class="span9">
        ...
        if ($_POST) {
            ...
            update_site_option('buddystream_facebookWall_setup', true);
        ...
        <blockquote>
            <p> <?php _e('facebook wall settings description', 'buddystream_facebook'); ?></p>
        </blockquote>
        ...
        <form method="post" action="">
            ...
            <table class="table table-striped" cellpadding="0" cellspacing="0">
                ...
                <? if (get_site_option('facestream_application_secret') != "" && get_site_option('facestream_application_id') != "") { ?>
                    ...
                    <thead>
                    <tr>
                        <th><?php _e('Wall options', 'buddystream_facebook');?></th>
                        <th></th>
                    </tr>
                    </thead>

                    <tr>
                        <td><?php _e('Allow users to sync wall links to activity?', 'buddystream_facebook');?></td>
                        <td><input class="switch icons" type="checkbox" name="facestream_user_settings_synclinksbp"
                                   id="facestream_user_settings_synclinksbp"/></td>
                    </tr>

                    <tr>
                        <td><?php _e('Allow users to sync wall photos to activity?', 'buddystream_facebook');?></td>
                        <td><input class="switch icons" type="checkbox" name="facestream_user_settings_syncphotosbp"
                                   id="facestream_user_settings_syncphotosbp"/></td>
                    </tr>

                    <tr>
                        <td><?php _e('Allow users to sync wall videos to activity?', 'buddystream_facebook');?></td>
                        <td><input class="switch icons" type="checkbox" name="facestream_user_settings_syncvideosbp"
                                   id="facestream_user_settings_syncvideosbp"/></td>
                    </tr>
