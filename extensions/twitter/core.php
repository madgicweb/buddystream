...
if( ! get_site_option('buddystream_nocss')) {
    wp_enqueue_style('buddystream_twitter', BP_BUDDYSTREAM_URL . '/extensions/twitter/style.css');
}

wp_enqueue_script('buddystream_twitter', BP_BUDDYSTREAM_URL . '/extensions/twitter/main.js',array(),false,true);
