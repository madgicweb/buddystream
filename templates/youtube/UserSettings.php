<?php
if ($_POST) {
    update_usermeta($bp->loggedin_user->id, 'bs_youtube_username', $_POST['bs_youtube_username']);
    echo '<div id="message" class="updated fade">
            <p>' . __('Settings saved', 'buddystream_lang') . '</p>
        </div>';
    }

    $bs_youtube_username = get_usermeta($bp->loggedin_user->id, 'bs_youtube_username');
