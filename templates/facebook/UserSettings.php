...
if ($_POST) {
    ...
    if (get_usermeta($bp->loggedin_user->id, 'facestream_session_key')) {
       ...
       <br><h5><?php echo __('Filters', 'buddystream_lang');?></h5>
        ...
        Note: Each site also has a "Global" list of filters and its settings will override these settings. ', 'buddystream_lang');
        ?>
       <br>
        ...
        <?php if(get_site_option('facestream_user_settings_syncupdatesbp')==0){ ?>
            ...
            <input type="radio" name="facestream_syncupdatestoac" id="facestream_syncupdatestoac" value="0" <?php if($facestream_syncupdatestoac==0){echo'checked';}?>> <?= __('Yes','buddsytream_lang');?><br>
            <input type="radio" name="facestream_syncupdatestoac" id="facestream_syncupdatestoac" value="1" <?php if($facestream_syncupdatestoac==1){echo'checked';}?>> <?= __('No','buddsytream_lang');?><br>
        <?php } ?>
        ...
        <?php if(get_site_option('facestream_user_settings_synclinksbp')==0){ ?>
    		...
    		<input type="radio" name="facestream_synclinkstoac" id="facestream_synclinkstoac" value="0" <?php if($facestream_synclinkstoac==0){echo'checked';}?>> <?= __('Yes','buddsytream_lang');?><br>
    		<input type="radio" name="facestream_synclinkstoac" id="facestream_synclinkstoac" value="1" <?php if($facestream_synclinkstoac==1){echo'checked';}?>> <?= __('No','buddsytream_lang');?><br>
    	<?php } ?>
        ...
        <?php if(get_site_option('facestream_user_settings_syncphotosbp')==0){ ?>
            ...
            <input type="radio" name="facestream_syncphotostoac" id="facestream_syncphotostoac" value="0" <?php if($facestream_syncphotostoac==0){echo'checked';}?>> <?= __('Yes','buddsytream_lang');?><br>
            <input type="radio" name="facestream_syncphotostoac" id="facestream_syncphotostoac" value="1" <?php if($facestream_syncphotostoac==1){echo'checked';}?>> <?= __('No','buddsytream_lang');?><br>
        <?php } ?>
    	...
    	<?php if(get_site_option('facestream_user_settings_syncvideosbp')==0){ ?>
    		...
    		<input type="radio" name="facestream_syncvideostoac" id="facestream_syncvideostoac" value="0" <?php if($facestream_syncvideostoac==0){echo'checked';}?>> <?= __('Yes','buddsytream_lang');?><br>
    		<input type="radio" name="facestream_syncvideostoac" id="facestream_syncvideostoac" value="1" <?php if($facestream_syncvideostoac==1){echo'checked';}?>> <?= __('No','buddsytream_lang');?><br>
    	<?php } ?>


        <?php if(defined('ACHIEVEMENTS_IS_INSTALLED')){ ?>
            <br><h5><?php echo __( 'Send achievements unlock to my facebook'  , 'buddystream_lang' );?></h5>
    		<input type="radio" name="facestream_achievements" id="facestream_achievements" value="1" <?php if($facestream_achievements==1){echo'checked';}?>> <?= __('Yes','buddsytream_lang');?><br>
    		<input type="radio" name="facestream_achievements" id="facestream_achievements" value="0" <?php if($facestream_achievements==0){echo'checked';}?>> <?= __('No','buddsytream_lang');?><br>
    	<?php } ?>
