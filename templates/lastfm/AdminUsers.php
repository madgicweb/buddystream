...
<table class="widefat fixed" cellspacing="0">
  ...
  <thead>
      <tr class="thead">
          ...
          <th scope="col" id="email" class="manage-column column-name" style=""><?= __('Last.fm', 'buddystream_lang'); ?></th>
          <th scope="col" id="role" class="manage-column column-role" style=""><?= __('Song history', 'buddystream_lang'); ?></th>
      </tr>
  </thead>
  ...
  <tfoot>
      <tr class="thead">
          ...
          <th scope="col" id="username" class="manage-column column-username" style="">Username</th>
          <th scope="col" id="email" class="manage-column column-name" style=""><?= __('Last.fm', 'buddystream_lang'); ?></th>
          <th scope="col" id="role" class="manage-column column-role" style=""><?= __('Song history imported', 'buddystream_lang'); ?></th>
      </tr>
  </tfoot>
