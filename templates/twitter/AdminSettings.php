...
<div class="wrap"><br/>
      ...
      <form method="post" action="">
          <table class="form-table">
            ...
            <th>
            <input type="radio" name="bs_twitter_hide_sitewide" id="facestream_user_settings_syncupdatesbp" value="1" <?php if(get_site_option('bs_twitter_hide_sitewide')==1){echo'checked';}?>> <label for="yes"><?php echo __( 'Yes', 'buddystream_lang' );?></label>
            <input type="radio" name="bs_twitter_hide_sitewide" id="facestream_user_settings_syncupdatesbp" value="0" <?php if(get_site_option('bs_twitter_hide_sitewide')==0){echo'checked';}?>> <label for="no"><?php echo __( 'No', 'buddystream_lang' );?></label>
            </th>
